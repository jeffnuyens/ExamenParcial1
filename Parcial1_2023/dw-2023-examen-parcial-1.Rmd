...
Respuesta: Es un axioma que postula que para cada familia de conjuntos no vacíos, existe otro conjunto que contiene un elemento de cada una de esas familias. Esta axioma es útil en análisis de datos porque facilita el manejo de muchas muestras y problemas de optimización en contextos más generales y abstractos. También, permite definir funciones y estructuras (como bases en espacios vectoriales) que serían imposibles de definir sin este axioma, ayudando así en el desarrollo de métodos avanzados de análisis.
...
Respuesta: Suponemos que la empresa no tolerará aquellos territorios con ventas negativas mayores a 10 ventas. 
